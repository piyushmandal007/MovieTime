...
const Navbar = () => {
 ...
 const {favoriteMovies} = useAppContext()
  ...
  return (
    <div className='fixed top-0 left-0 z-50 w-full flex items-center justify-between pl-3 pr-3 md:pl-4 md:pr-10 lg:pl-6 lg:pr-36 py-5'>
      <Link to='/' className='max-md:flex-1'>
        <img src={assets.movietime_logo} alt="MovieTime" className='w-56 md:w-64 h-auto object-contain'/>
      </Link>
